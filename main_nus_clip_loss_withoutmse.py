...
def cluster_contrastive(img_dim,text_dim):
    ...
    model.pretrain_MLP('result300/nus_wide/_128_29_UCMR.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--beta", default=100)#[10,1,0.1,0.01]
    parser.add_argument("--alpha", default=10) #[10,1,0.1,0.01]
