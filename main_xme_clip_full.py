...
def cluster_contrastive(img_dim,text_dim):
    ...
    model=CCMR(img_dim,text_dim,n_clusters=args.n_clusters,n_h=args.n_h,alpha=1.0,pretrain_path='result300/pascal/_128_29_UCMR.pt').to(device)
    print(model)
    #model.pretrain_MLP()

    model.pretrain_MLP('result300/xmedianet/_128_237_UCMR.pt')
