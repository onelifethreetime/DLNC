...
def evaluate1(model):
    ...
    print('Eval loss: ',running_loss/len(loader),'c_loss:',c_total / len(loader))
...
def evaluate(model):
    ...
    with torch.no_grad():
        for  xs,label,idx in loader:
            ...
            loss=kl_loss+args.alpha*contrastive_loss
...
def pretrain(model):
    ...
    for epoch in range(150):
        ...
        print('Pretrain_epoch {}'.format(epoch), 'loss:{:.6f}'.format(tot_loss / len(data_loader)),'c_loss:{:.6f}'.format(c_total / len(data_loader)))
